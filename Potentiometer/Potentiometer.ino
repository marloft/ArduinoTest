...
#define LED 13//the Grove - LED is connected to D3 of Arduino
...
void loop() 
{
  ...
  if (degrees < 50){
    // // Print a message to the LCD.
      lcd.print("Hey. I'm Finn.");   }   
  else if (degrees > 50 and degrees < 100){
     // Print a message to the LCD.
      lcd.print("I'm 12 years old.");}
  else if (degrees > 100 and degrees < 300){
     // Print a message to the LCD.
      lcd.print("Statement3.");}
  delay(500);
}
void pinsInit()
{
