...
const String GMAIL_USER_NAME = "loftus.mary@gmail.com";

// your application specific password (see instructions above)
const String GMAIL_APP_PASSWORD = "password";

// the email address you want to send the email to, eg "jane.doe@temboo.com"
const String TO_EMAIL_ADDRESS = "loftus.mary@gmail.com";
...
void loop()
{
  ...
  if (!attempted) {
    ...
    SendEmailChoreo.setAccountName("marloft");
    SendEmailChoreo.setAppKeyName("myFirstApp");
    SendEmailChoreo.setAppKey("SL7Bxh5xCVOBo2SpbwQE8dcrPH91lUtc");
